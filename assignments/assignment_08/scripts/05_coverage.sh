...
#SBATCH -o /sciclone/home/sshand/logs/annotate_%j.out # change this!
#SBATCH -e /sciclone/home/sshand/logs/annotate_%j.err # change this!
...
joined="${ANNOT_DIR}/${samplename}/${samplename}_SS.with_cov.tsv" #CHANGE IN TO YOUR INITIAL
